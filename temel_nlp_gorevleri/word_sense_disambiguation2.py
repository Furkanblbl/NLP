...
# example sentences
sentences = [
    "I go to the bank to deposite money",
...
for s in sentences:
    print(f"Sentence: {s}")
    sense_simle_lesk = simple_lesk(s,word)
    print(f"Sense simple: {sense_simle_lesk.definition()}")
...
"""
Sentence: I go to the bank to deposite money
