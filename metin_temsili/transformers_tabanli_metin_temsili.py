...
# metnitokenlara cevir
inputs = tokenizer(text, return_tensors="pt") # cikti pytTorch tensor olarak return edilir 

# modeli kullanarak metin temsili olustur
with torch.no_grad(): # gradyanlarin hesaplanmasini durdurulur, boylece bellegi daha verimli kullaniriz
